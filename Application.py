...
class Ui_MainWindow(object):
    ...
    def click_process(self):
        ...
        args = GUINamespace()
        args.input_dir = os.path.normpath(self.InputText_Field.toPlainText())
        args.output_dir = os.path.normpath(self.OutputText_Field.toPlainText())
        args.verbose = True
        args.regs = scrapper() if not self.Registers_Checkbox.isChecked() \
                                else self.Registers_Field.toPlainText().split(" ")
